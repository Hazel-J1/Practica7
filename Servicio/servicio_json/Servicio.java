...
public class Servicio
{
  ...
  public Response alta(@FormParam("usuario") Usuario usuario) throws Exception
  {
    ...
    try
    {
      ...
      PreparedStatement stmt_1 = conexion.prepareStatement("INSERT INTO productos(id_usuario,nombre,descripcion,precio,cantidad) VALUES (0,?,?,?,?)");
  ...
  public Response modifica(@FormParam("usuario") Usuario usuario) throws Exception
  {
    ...
    try
    {
      PreparedStatement stmt_1 = conexion.prepareStatement("UPDATE productos SET descripcion=?,precio=?,cantidad=? WHERE nombre=?");
      try
      {
  ...
  public Response borra(@FormParam("nombre") String nombre) throws Exception
  {
    ...
    try
    {
      PreparedStatement stmt_1 = conexion.prepareStatement("SELECT 1 FROM productos WHERE nombre=?");
      try
      {
        stmt_1.setString(1,nombre);
	...
	stmt_2.executeUpdate();
      ...
      PreparedStatement stmt_3 = conexion.prepareStatement("DELETE FROM productos WHERE nombre=?");
      try
      {
